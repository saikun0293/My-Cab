...
router.get("/history", function (req, res) {
  var query =
    "select car.carName,branch.branchName,details.bookingTime,details.fromTime,details.toTime from booking join details using(bookingId) join car using(carId) join branch using(branchId) where booking.userId=21 ";
